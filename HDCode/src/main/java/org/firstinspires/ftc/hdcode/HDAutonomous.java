...
public class HDAutonomous extends HDOpMode{
    ...
    public void initialize() {
        ...
        strategyMenu.addChoice("Non Relic DoubleGlyph & Jewel", Strategy.NONRELICGLYPHJEWEL);
        ...
        switch(strategy){
            case NONRELICGLYPHJEWEL:
                if(alliance == Alliance.RED_ALLIANCE)
                    HDAuto = new Red_NonRelic_DoubleGlyph_Jewel(delay, alliance, hardwareMap, dashboard);
                else
                    HDAuto = new Blue_NonRelic_DoubleGlyph_Jewel(delay, alliance, hardwareMap, dashboard);
                break;
