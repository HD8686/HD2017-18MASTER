...
public class Blue_NonRelic_Multi_Glyph_Jewel implements HDAuto {
    ...
    public Blue_NonRelic_Multi_Glyph_Jewel(double delay, Alliance alliance, HardwareMap hardwareMap, HDDashboard dashboard){
        ...
        if(ready()){
            ...
            switch(states){
                ...
                case wait3:
                    ...
                    int ultrasonic = robot.rightUS.rawUltrasonic();
                    if(ultrasonic < 200){
                        list.add(((double) robot.rightUS.rawUltrasonic()));
                    }
                    robot.robotDrive.motorBreak();
                    break;
                ...
                case wait4:
                    ...
                    break;
                case driveForward:
                    SM.setNextState(States.openBox, HDWaitTypes.EncoderChangeBoth, 100.0);
                ...
                case strafeToGlyphs:
                    switch (vuMark) {
                        case UNKNOWN:
                            SM.setNextState(States.wait5, HDWaitTypes.EncoderChangeIndividualAvg, 500.0);
                            robot.robotDrive.mecanumDrive_Polar(.25, 90, 0, robot.IMU1.getZheading());
                            break;
                        case LEFT:
                            SM.setNextState(States.wait5, HDWaitTypes.EncoderChangeDiag, 600.0);
                            robot.robotDrive.mecanumDrive_Polar(.25, 90, 0, robot.IMU1.getZheading());
                            break;
                        case CENTER:
                            SM.setNextState(States.wait5, HDWaitTypes.EncoderChangeDiag, 500.0);
                            robot.robotDrive.mecanumDrive_Polar(.25, 90, 0, robot.IMU1.getZheading());
                            break;
                        case RIGHT:
                            SM.setNextState(States.wait5, HDWaitTypes.EncoderChangeDiag, 400.0);
                            robot.robotDrive.mecanumDrive_Polar(.25, 90, 0, robot.IMU1.getZheading());
                            break;
                    }
                    break;
                ...
                case strafeToColumn:
                    ...
                    switch (vuMark) {
                        case UNKNOWN:
                            SM.setNextState(States.wait6, HDWaitTypes.EncoderChangeIndividualAvg, 0.01963*ultrasonicReading*ultrasonicReading - 24*(ultrasonicReading) + 1412.1094);
                            robot.robotDrive.mecanumDrive_Polar(.25, -90, 0, robot.IMU1.getZheading());
                            break;
                        case RIGHT:
                            SM.setNextState(States.wait6, HDWaitTypes.EncoderChangeDiag, 0.02956*ultrasonicReading*ultrasonicReading - 24.23*(ultrasonicReading) + 1724.508);
                            robot.robotDrive.mecanumDrive_Polar(.25, -90, 0, robot.IMU1.getZheading());
                            break;
                        case CENTER:
                            SM.setNextState(States.wait6, HDWaitTypes.EncoderChangeDiag, 0.02956*ultrasonicReading*ultrasonicReading - 24.23*(ultrasonicReading) + 1724.508);
                            ...
                            break;
                        case LEFT:
                            SM.setNextState(States.wait6, HDWaitTypes.EncoderChangeDiag, -0.01098*ultrasonicReading*ultrasonicReading - 20*(ultrasonicReading) + 935.64);
                            robot.robotDrive.mecanumDrive_Polar(.25, -90, 0, robot.IMU1.getZheading());
                            break;
                    }
                    break;
                case wait6:
                    ...
                    break;
                case driveForward2:
                    SM.setNextState(States.openBox2, HDWaitTypes.EncoderChangeBoth, 100.0);
                    robot.robotGlyph.extendBox();
                    robot.robotDrive.VLF(-.25, 180, 0.01, 2, robot.IMU1.getZheading());
                    break;
                case openBox2:
                ...
                case driveAwayToPush2:
                    ...
                    break;
                case pushInGlyph2:
                    SM.setNextState(States.backAway2, HDWaitTypes.EncoderChangeBoth, 255.0);
                    robot.robotDrive.tankDrive(-.25, -.25);
                    break;
                case backAway2:
