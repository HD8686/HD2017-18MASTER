...
/**
 * Created by FIRSTMentor on 3/29/2018.
 */
 ...
 *
 */
public class StandardPathPlanner
{
     ...
     * @param path
     */
    public StandardPathPlanner(double[][] path)
    {
    ...
    public static void main(String[] args)
    {
        ...
        final StandardPathPlanner path = new StandardPathPlanner(waypoints);
